...
//                        var_dump($artSortType . ' ' . $sortid);
                        if ((int)$artSortType === (int)$sortid) {
                            ...
                            $indexes[] = $index;
                            $palletweight += ((intval($art["inset_gram"]) * intval($art["inset_limit"])) * intval($pallet["article_amount"]));
                            $totpalletweight += ((intval($art["inset_gram"]) * intval($art["inset_limit"])) * intval($pallet["article_amount"]));
...
//                                var_dump($uniqueSort);
                            ...
                            $uniqueSort[$sortDesc["description"]] += round(((intval($art["inset_gram"]) * intval($art["inset_limit"])) * intval($pallet["article_amount"])) / 1000, 2);
