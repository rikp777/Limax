<template>
    <div>
        <b-card>
            <b-form-group id="id" label="Vrachtbrief ID" label-for="id">
            <b-input
                id="id"
                name="id"
                v-model="uniqueshippingid"
                type="number"
                v-on:keyup.enter="loadShippinglabel"
                min="0.00"/>
            </b-form-group>
        </b-card>
        <hr>
                            ...
                            <div class="label1" style="page-break-after: always;">
                                ...
                                <div class="row">
                                    <div class="col-sm-6" style="font-size: 16px;">
                                        <strong>shippinglabel: </strong>{{uniqueshippingid}} |
                                        <strong>printed: </strong>{{$moment().format('dddd, MMMM Do YYYY') + ' ' +
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6" style="font-size: 20px;">
                                            <table style="width: 100%">
                                                ...
                                                <tbody>
                                                <tr v-for="total in ShippingLabelPalletLabels['total']"
                                                    v-if="articles.length">
                                                    <td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadShippinglabel() {
                this.ready = false;
                this.$store.dispatch("getShippingLabel", this.uniqueshippingid).then(() => {
                    this.getAllArticles()
                    // console.log(this.ShippingLabelPalletLabels.shippinglabelId[0].farmerId)
                    this.getFarmer(this.ShippingLabelPalletLabels.shippinglabelId[0].farmerId)
                    this.ready = true
                })
            },
